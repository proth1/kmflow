/**
 * State Street APEX Presentation Auth Worker
 *
 * Server-side OTP authentication for State Street APEX presentation using Descope.
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    // to a named .html file caused a production incident (2026-02-17)
    // where users were silently served stale content for hours.
...
/**
 * Render the login page with OTP authentication
 */
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Sign In - State Street APEX</title>
  <link href="https://fonts.googleapis.com/css2?family=Open+Sans+Condensed:wght@300;700&family=Open+Sans:wght@300;400;600;700&display=swap" rel="stylesheet">
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body {
...
<body>
  <div class="login-container">
    <div class="logo">
      ...
      <div class="product-tagline">Confidential - Authorized Access Only</div>
    </div>
    <p class="subtitle">Sign in to access this presentation</p>
