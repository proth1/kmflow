...
async def extract_from_evidence(
    ...
    Returns:
        ExtractionSummary with resolved entities and provenance maps.
    """
    ...
    for fragment in fragments:
        ...
        result: ExtractionResult = await extract_entities(fragment.content, fragment_id=frag_id)
    ...
    # Resolve entities (merge near-duplicates)
